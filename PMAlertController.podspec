Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   ...
                   DESC
  s.homepage     = "https://github.com/AlissonEnz/PMAlertController/"
  ...
  s.social_media_url   = "http://twitter.com/alissonenz"
  s.platform     = :ios, "9.0"
  s.source       = { :git => "https://github.com/AlissonEnz/PMAlertController.git", :tag => s.version }
